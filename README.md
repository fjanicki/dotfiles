...
- The installation and runcom setup is [tested weekly on real Ubuntu and macOS
  machines](https://github.com/fjanicki/dotfiles/actions) (Big Sur and Monterey;
...
```bash
bash -c "`curl -fsSL https://raw.githubusercontent.com/fjanicki/dotfiles/master/remote-install.sh`"
```
...
```bash
git clone https://github.com/fjanicki/dotfiles.git ~/.dotfiles
```
...
[GitHub Action](https://github.com/fjanicki/dotfiles/actions).
